...
builder.Services.AddScoped<CinemasController>();


builder.Services.AddMediatR(x => x.RegisterServicesFromAssembly(typeof(GetAllCinemaQuery).Assembly));
